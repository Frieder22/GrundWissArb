...
Eines der Beispiele (Abbildung \ref{fig:Tuwien}) ist dabei aus einer Vorlesung des Sommersemesters 2023.
\begin{figure}[h]
	\centering
...
In neueren Quellen (ab ca. 2019) wie beispielsweise durch Belkin et al. \cite{Belkin_2019} wird darauf hingewiesen, dass nach dem Anstieg des Testfehlers für höhere Modellkomplexität der Testfehler wieder abfällt. Dazu wird eine Grafik wie in Abbildung \ref{fig:doubleDescent} zur Erklärung verwendet.
\begin{figure}[h]
	\centering
